...
class OpenDeyimAPI{
    ...
    Translate = (Arguments = { Query, Source: 'auto', Target: 'en', Format: 'text' }) => 
                Axios.post(this.BaseURL + '/translate', Arguments);
    Detect = (Arguments = { Query }) => Axios.post(this.BaseURL + '/detect', Arguments);
    Languages = () => Axios.get(this.BaseURL + '/languages');
};

module.exports = OpenDeyimAPI;
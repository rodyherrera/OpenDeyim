...
import argparse
from Source.Init import CheckAndInstallModels

if __name__ == '__main__':
    Parser = argparse.ArgumentParser()
    Parser.add_argument('--LoadOnlyLanguageCodes', type = str, default = '')
    Arguments = Parser.parse_args()
    LanguageCodes = Arguments.LoadOnlyLanguageCodes.split(',')
    if len(LanguageCodes) == 0 or LanguageCodes[0] == '':
        LanguageCodes = None
    CheckAndInstallModels(Force = True, LoadOnlyLangCodes = LanguageCodes)